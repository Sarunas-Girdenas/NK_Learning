...
%     B(3,3) = rho;
    ...
    stabilityCondition.capital     = checkStability( eig(H_Capital) );
    stabilityCondition.inflation   = checkStability( eig(H_Inflation) );
    stabilityCondition.interest    = checkStability( eig(H_Interest) );
    stabilityCondition.markup      = checkStability( eig(H_Markup) );
    stabilityCondition.wage        = checkStability( eig(H_Wage) );
