...
ActualLawOfMotion.A(1,2) = 0.005; % sqrt(3)*0.02*(rand-0.5)
...
HH_Capital_Learning   = BoundedMemoryNeuralNetwork( memoryLength_HH, SteadyStateValuesNK.k, SteadyStateValuesNK.k );
HH_Wage_Learning      = BoundedMemoryNeuralNetwork( memoryLength_HH, SteadyStateValuesNK.w, SteadyStateValuesNK.k );
HH_Inflation_Learning = BoundedMemoryNeuralNetwork( memoryLength_HH, 1, SteadyStateValuesNK.k );
HH_Interest_Learning  = BoundedMemoryNeuralNetwork( memoryLength_HH, SteadyStateValuesNK.R, SteadyStateValuesNK.k );
HH_Markup_Learning    = BoundedMemoryNeuralNetwork( memoryLength_HH, SteadyStateValuesNK.X, SteadyStateValuesNK.k );
...
FF_Capital_Learning   = BoundedMemoryNeuralNetwork( memoryLength_FF, SteadyStateValuesNK.k, SteadyStateValuesNK.k );
FF_Inflation_Learning = BoundedMemoryNeuralNetwork( memoryLength_FF, 1, SteadyStateValuesNK.k );
FF_Markup_Learning    = BoundedMemoryNeuralNetwork( memoryLength_FF, SteadyStateValuesNK.X, SteadyStateValuesNK.k );
...
% 
%figure
%plot(ActualLawOfMotion.capital,'r')
% hold
